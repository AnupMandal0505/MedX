...
from .views import ai_prediction,contact_us,about_us, term_and_condition,site_maintenance,our_product,appointment_letter,doctor_profile, home,register,verify_otp,login,dasboard,appointment,send_meet_link, user_history,show_appointment,prescription,patient,payment,crud,check_diagnosis,common_diseases
...
urlpatterns = [
    ...
    path("site_maintenance",site_maintenance.site_maintenance,name = "site_maintenance"),
